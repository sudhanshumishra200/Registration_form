...
export default function LoginForm() {
    ...
    return (
        <div className='w-full h-[100vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 bg-purple-400	'>
            ...
            <div className="displayData md:border-l-[4px] border-gray-700 bg-purple-300">
                <h3 className='text-center bg-lime-400 text-4xl mt-1 md:mt-0 '>Submitted Data</h3>
